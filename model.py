...
class Decoder(nn.Module):
    ...
    def __init__(self, Ns, Ss, unet_args):
        ...
        for i in range(self.depth):
            self.dblocks.append(
                D_Block(layer_idx=i, N0=self.Ns[i + 1], N=self.Ns[i], S=self.Ss[i], num_tfc=unet_args.num_tfc))
...
class Encoder(nn.Module):
    ...
    def __init__(self, N0, Ns, Ss, unet_args):
        ...
        for i in range(self.depth):
            ...
            self.eblocks.append(
                E_Block(layer_idx=i, N0=Nin, N01=self.Ns[i], N=self.Ns[i + 1], S=self.Ss[i], num_tfc=unet_args.num_tfc))
